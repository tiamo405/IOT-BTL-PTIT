...
def api_add_family(image, name="test", dob="01/01/2000", gender="", role="family") :
    # khoi tao error
...
def add_family_manually(image, name="test", dob="01/01/2000", gender="", role="family", push = True):
    ERROR = "File uploaded successfully"
    try:
        image = cv2.imread(image)
    except :
